...
![Design preview for the Huddle landing page with single introductory section](https://i.imgur.com/yYAILBc.jpg)
...
[Click here to see my challenge done](https://huddle-landing-page.vicckm.vercel.app/)
...
1. Initialize your project as a public repository on GitHub. Use the command `npm install` in terminal to download the dependencies this project, next, use `npm start`. This will make it easier to share your code with the community if you need some help. If you're not sure how to do this, have a read through of this Try Git resource.
